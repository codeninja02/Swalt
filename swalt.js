...
document.getElementById("alertBtn").addEventListener("click", function(e) {
    let alertSuperContainerEl = document.getElementById("alertSuperContainer");
    alertSuperContainerEl.classList.add("alert-c-ph-1");
    alertInput.dispatchEvent(customEvent2);
    setTimeout(function(){
        alertSuperContainerEl.classList.add("alert-hidden");
